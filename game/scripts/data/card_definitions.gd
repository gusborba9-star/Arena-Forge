...
static func initial() -> Array[Dictionary]:
    return [
        {"id":"ice_wall","name":"Muralha de Gelo","energy_cost":3,"effects":[{"kind":"tile","tile_id":"ice"}]},
        {"id":"wind_blast","name":"Rajada de Vento","energy_cost":2,"effects":[{"kind":"push","value":110,"area":170}]},
        {"id":"oil_pool","name":"Poça de Óleo","energy_cost":2,"effects":[{"kind":"tile","tile_id":"oil"}]},
        ...
        {"id":"meteor","name":"Meteoro","energy_cost":5,"effects":[{"kind":"damage","value":65,"area":190},{"kind":"push","value":90,"area":190},{"kind":"tile","tile_id":"fire"}]},
